...
Note that all R code used to produce the calculations and plots is included the Appendix but not displayed in the narrative for the sake of brevity.
...
We calculate the theoretical mean of the exponential distribution with the formula $\frac{1}{\lambda}$. To see how this compares with the sample mean, lets calculate both and compare.
