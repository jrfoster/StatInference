...
From this we can see that we have 100% complete cases and that we will need to treat dose as discrete (factor) instead of as  continuous (numeric) variable.  The appendix contains a basic visual look at the data, so lets take a look to see if any relationships or patterns emerge with a little closer look.
