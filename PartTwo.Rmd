...
kable(
  data.frame(
    "Ascorbic Acid", 
    "Orange Juice", 
    paste("[", round(t1$conf.int[1],4), ", ", round(t1$conf.int[2],4), "]"
          , sep=""), 
